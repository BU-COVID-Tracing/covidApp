...
async function configureAndroid(projectRootPath, { resizeMode, backgroundColor, darkModeBackgroundColor, imagePath, darkModeImagePath, }) {
    ...
    await Promise.all([
        ...
        Colors_xml_1.default(androidMainPath, backgroundColor, darkModeBackgroundColor),
